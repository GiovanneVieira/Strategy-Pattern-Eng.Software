...
//        System.out.println(ptAtleta.comportamento_pato());
        ...
        Coelho coelhoPequeno = new Coelho_Pequeno();
        System.out.println(coelhoPequeno.mostrar());
        System.out.println(coelhoPequeno.getComportamento());

        Coelho coelhoGordo = new Coelho_Gordo();
        System.out.println(coelhoGordo.mostrar());
        System.out.println(coelhoGordo.getComportamento());
