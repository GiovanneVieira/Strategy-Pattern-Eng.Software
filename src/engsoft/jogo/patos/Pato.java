...
//  Novo tipo de comportamento Pulo incluido na implementação da super classe
...
//  Separação de setters para comportamento
...
//  Modificação de getter com base no comportamento inicializado pela sub classe
